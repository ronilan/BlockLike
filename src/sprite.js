  ...
  */
  constructor(options = {}) {
    ...
    */
    ...
    /*
    * alternate options - short-circut the costume.
    * user can set costume properties directly to sprite using the option object.
    */
    if (!actual.costume && (actual.width || actual.height || actual.image || actual.color)) {
      const costumeOptions = {};
      actual.width ? costumeOptions.width = actual.width : null;
      actual.height ? costumeOptions.height = actual.height : null;
      actual.image ? costumeOptions.image = actual.image : null;
    ...
    */
    ...
    // when none is set as actual, and no options, it means default is sheepy
